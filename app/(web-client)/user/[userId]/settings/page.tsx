  ...
  const fetchSettings = async () => {
    try {
      ...
      setNotificationEmail(
        userProfile?.notificationPreferences.emailGigUpdates || false
      );
      setNotificationSms(
        userProfile?.notificationPreferences.smsGigAlerts || false
      );
            ...
            <>
              ...
              >
                <StripeModal
                  ...
                  handleCloseModal={() => setShowStripeModal(false)}
